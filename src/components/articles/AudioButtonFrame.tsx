// Moldura visual compartilhada por ListenButton (Web Speech API) e
// AudioPlayerButton (MP3 gerado pelo Piper) — estilo de anúncio classificado
// de jornal antigo (moldura dupla, losangos, ornamentos de canto). Extraído
// para um componente próprio para as duas formas de "ouvir matéria" nunca
// ficarem visualmente diferentes uma da outra.
"use client";

export function AudioButtonFrame({
  active,
  label,
  onClick,
}: {
